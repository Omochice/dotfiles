...
}:
{
  ...
  claude-skill-mattpocock = {
    ...
    version = "9fecab929abb904c68ce3366a1781df31ab22832";
    src = fetchFromGitHub {
      owner = "mattpocock";
      repo = "skills";
      rev = "9fecab929abb904c68ce3366a1781df31ab22832";
      fetchSubmodules = false;
      sha256 = "sha256-nBvVsa8bYeXWQ5t3aGLgAPui685h8nNLqYqIIgi443E=";
    };
    date = "2026-05-10";
  };
  claude-skill-tani = {
  ...
  neovim = {
    pname = "neovim";
    version = "5370eb01469622e02c5831b3c4063c02449a4c5c";
    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "5370eb01469622e02c5831b3c4063c02449a4c5c";
      fetchSubmodules = false;
      sha256 = "sha256-3JxUYjRlAeR6WGbe4nInkHXYljiEz5wemLssxKX+sQQ=";
    };
    date = "2026-05-10";
  };
  tree-sitter-moonbit = {
