...
}:
{
  ...
  claude-skill-mattpocock = {
    ...
    version = "b56795bed1236302f42f61449210bf50cdbb8859";
    src = fetchFromGitHub {
      owner = "mattpocock";
      repo = "skills";
      rev = "b56795bed1236302f42f61449210bf50cdbb8859";
      fetchSubmodules = false;
      sha256 = "sha256-JpD4A5wmcZWiOexb3eYAqWwsL2J6maWf40LN/89xVHk=";
    };
    date = "2026-04-28";
  };
  claude-skill-tani = {
  ...
  neovim = {
    pname = "neovim";
    version = "8308544fe588f34f5e1985d1fb37f64b41f91873";
    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "8308544fe588f34f5e1985d1fb37f64b41f91873";
      fetchSubmodules = false;
      sha256 = "sha256-AvQNnQ2bOsIRaeVt4/IUeJ6gtjkKz9IHTYyek/AyqFE=";
    };
    date = "2026-04-26";
  };
  tree-sitter-moonbit = {
