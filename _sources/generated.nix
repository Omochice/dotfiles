...
}:
{
  ...
  claude-skill-mattpocock = {
    ...
    version = "0288510dd61ff6ef7c2003834082ab8f2387e80e";
    src = fetchFromGitHub {
      owner = "mattpocock";
      repo = "skills";
  ...
  neovim = {
    pname = "neovim";
    version = "c622b454b53a5d9edfc6f5ce71806fe8f487677d";
    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "c622b454b53a5d9edfc6f5ce71806fe8f487677d";
      fetchSubmodules = false;
      sha256 = "sha256-D1KFiTvKMYzPgIhkTzyv04G3RefteW4VgCKoLitQvOY=";
    };
    date = "2026-06-12";
  };
  tree-sitter-moonbit = {
