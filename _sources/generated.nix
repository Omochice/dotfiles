...
}:
{
  ...
  claude-skill-lacolaco = {
    ...
    version = "99e85886dfa3e4fcde3f2130c640e3b35d12f27a";
    src = fetchFromGitHub {
      owner = "lacolaco";
      repo = "claude-plugins";
      rev = "99e85886dfa3e4fcde3f2130c640e3b35d12f27a";
      fetchSubmodules = false;
      sha256 = "sha256-Yxt2zgrg6P7RU2J6fwRQ8XQlGVSKKvMDVW/I5OC81fc=";
    };
    date = "2026-05-14";
  };
  ...
  neovim = {
    pname = "neovim";
    version = "799cbfff855c72282a54646f3e5e1b71b0da223c";
    src = fetchFromGitHub {
      owner = "neovim";
      repo = "neovim";
      rev = "799cbfff855c72282a54646f3e5e1b71b0da223c";
      fetchSubmodules = false;
      sha256 = "sha256-2fbk3ydhNa25zk8kckSXtLuKX6B0JIUrUUhdYqTQVfY=";
    };
    date = "2026-05-20";
  };
  tree-sitter-moonbit = {
