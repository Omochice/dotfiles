...
import type { WalkEntry } from "https://deno.land/std@0.220.1/fs/mod.ts";
...
import { expandGlobSync } from "https://deno.land/std@0.220.1/fs/expand_glob.ts";
import { move } from "https://deno.land/std@0.220.1/fs/move.ts";
