...
import type { WalkEntry } from "https://deno.land/std@0.216.0/fs/mod.ts";
...
import { expandGlobSync } from "https://deno.land/std@0.216.0/fs/expand_glob.ts";
import { move } from "https://deno.land/std@0.216.0/fs/move.ts";
