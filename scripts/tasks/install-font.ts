...
import type { WalkEntry } from "https://deno.land/std@0.218.2/fs/mod.ts";
...
import { expandGlobSync } from "https://deno.land/std@0.218.2/fs/expand_glob.ts";
import { move } from "https://deno.land/std@0.218.2/fs/move.ts";
