...
-- textobj
vimx.keymap.set({ "o", "x" }, "ib", [[<Plug>(textobj-sandwich-auto-i)]], { remap = true })
vimx.keymap.set({ "o", "x" }, "ab", [[<Plug>(textobj-sandwich-auto-a)]], { remap = true })
vimx.keymap.set({ "o", "x" }, "is", [[<Plug>(textobj-sandwich-query-i)]], { remap = true })
vimx.keymap.set({ "o", "x" }, "as", [[<Plug>(textobj-sandwich-query-a)]], { remap = true })
-- }}}
