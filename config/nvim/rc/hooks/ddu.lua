...
vimx.keymap.set("n", prefix .. "<C-p>", function()
  vimx.fn.ddu.start({
    ui = "ff",
    sources = { {
      name = "file_external",
...
vimx.keymap.set("n", prefix .. "<C-w>", function()
  vimx.fn.ddu.start({
    ui = "ff",
    sources = { {
      name = "mr",
...
vimx.keymap.set("n", prefix .. "<C-i>", function()
  vimx.fn.ddu.start({
    ui = "ff",
    sources = { {
      name = "redmine_issue",
...
vimx.keymap.set("n", prefix .. "<C-b>", function()
  vimx.fn.ddu.start({
    ui = "ff",
    sources = { {
      name = "buffer",
...
vimx.keymap.set("n", prefix .. "<C-l>", function()
  vimx.fn.ddu.start({
    ui = "ff",
    sources = { {
      name = "rg",
...
vimx.keymap.set("n", prefix .. "<C-t>", function()
  local id = vimx.fn.denops.callback.register(function(s)
...
vimx.create_command("DduGrep", function(opts)
...
vimx.create_autocmd("LspAttach", {
  ...
  callback = function()
    ...
    vimx.keymap.set("n", "<Space>a", function()
      vimx.fn.ddu.start({
        ui = "ff",
        sources = { {
          name = "lsp_codeAction",
...
-- lua_source {{{
local vimx = require("artemis")
vimx.fn.ddu.custom.load_config(vimx.fn.expand("$VIMRC_RC_DIR/ts/ddu.ts"))
-- }}}
